...
from studentmanagesysapp.models import Students, Courses, Subjects, CustomUser, Attendance, AttendanceReport, \
...
def student_home(request):
    ...
    return render(request,"student_templateO/student_home_template.html",{"total_attendance":attendance_total,"attendance_absent":attendance_absent,"attendance_present":attendance_present,"subjects":subjects,"data_name":subject_name,"data1":data_present,"data2":data_absent,"class_room":class_room})
        ...
        if session.exists():
            ...
            if check_course.exists():
                ...
                if session_check.exists():
                    ...
                    return render(request,"student_templateO/join_class_room_start.html",{"username":request.user.username,"password":onlineclass.room_pwd,"roomid":onlineclass.room_name})
...
def student_view_attendance(request):
    ...
    return render(request,"student_templateO/student_view_attendance.html",{"subjects":subjects})
...
def student_view_attendance_post(request):
    ...
    return render(request,"student_templateO/student_attendance_data.html",{"attendance_reports":attendance_reports})
...
def student_apply_leave(request):
    ...
    return render(request,"student_templateO/student_apply_leave.html",{"leave_data":leave_data})
...
def student_feedback(request):
    ...
    return render(request,"student_templateO/student_feedback.html",{"feedback_data":feedback_data})
...
def student_profile(request):
    ...
    return render(request,"student_templateO/student_profile.html",{"user":user,"student":student})
...
def student_all_notification(request):
    ...
    return render(request,"student_templateO/all_notification.html",{"notifications":notifications})

def student_view_result(request):
    student=Students.objects.get(admin=request.user.id)
    studentresult=StudentResult.objects.filter(student_id=student.id)
    return render(request,"student_templateO/student_result.html",{"studentresult":studentresult})