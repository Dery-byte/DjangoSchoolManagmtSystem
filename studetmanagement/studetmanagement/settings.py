...
ROOT_URLCONF = 'studetmanagement.urls'
...
WSGI_APPLICATION = 'studetmanagement.wsgi.application'
...
STATIC_URL = '/static/'
AUTH_USER_MODEL="studentmanagesysapp.CustomUser"
AUTHENTICATION_BACKENDS=['studentmanagesysapp.EmailBackEnd.EmailBackEnd']
