...
from studentmanagesysapp import views, HodViews, StaffViews, StudentViews
from studentmanagesysapp.EditResultVIewClass import EditResultViewClass
from studetmanagement import settings
...
urlpatterns = [
    ...
    # End Urls
    path('add_exams/', StaffViews.add_exams_template,name="add_exams"),
    path('staff_add_exams/', StaffViews.staff_add_exams,name="staff_add_exams"),
    path('view_exams/', StaffViews.staff_view_exams,name="view_exams"),

    path('staff_add_question/', StaffViews.staff_add_question,name="staff_add_question"),
    path('add_question/', StaffViews.add_question_template,name="add_question"),
    path('view_questions/', StaffViews.staff_view_questions,name="view_questions"),
